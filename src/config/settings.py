...
# IMAGE_CONFIDENCE é mantido como fallback para compatibilidade com .env antigos.
IMAGE_CONFIDENCE = _get_float("IMAGE_CONFIDENCE", 0.80)
ICON_IMAGE_CONFIDENCE = _get_float(
    "ICON_IMAGE_CONFIDENCE",
    IMAGE_CONFIDENCE,
)
TEXT_IMAGE_CONFIDENCE = _get_float(
...
FOCUS_CLICK_MAX_ATTEMPTS = _get_int("FOCUS_CLICK_MAX_ATTEMPTS", 6)
